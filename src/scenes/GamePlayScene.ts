...
export class GamePlayScene extends Phaser.Scene {
    ...
    gameTime: number
    spineGroup: Phaser.GameObjects.Group
    boy: Boy
    constructor() {
        super('GamePlayScene')
    }
    ...
    create() {
        ...
        // //@ts-ignore
        // this.physics.world.enable(this.boy)
        // //@ts-ignore
        // this.boy.body
        // //@ts-ignore
        //     .setGravityY(2338)
        ...
        //camera later
        this.cameras.main.startFollow(this.boy.instance, true)
        //this.cameras.main.setLerp(1,0)
        this.physics.world.setBoundsCollision(true, false, false, true)

        //collider
        //@ts-ignore
        this.physics.add.collider(this.boy.instance, this.goombas, this.handleGoombaPlayerCollide, undefined, this)
        //@ts-ignore
        this.physics.add.collider(this.boy.instance, this.boxes, this.handleBoxCollide, undefined, this)
        //@ts-ignore
        this.physics.add.collider(this.boy.instance, this.bricks, this.handleBrickCollide, undefined, this)
        //@ts-ignore
        this.physics.add.collider(this.boy.instance, this.groundLayer)
        this.physics.add.collider(this.goombas, this.groundLayer)

        //@ts-ignore
        this.physics.add.collider(this.boy.instance, this.pipeLayer)
    ...
    update(time: number, delta: number) {
        //@ts-ignore
        if(this.boy.instance.body.onFloor()){
            this.cameras.main.setLerp(1,0)
        }
        //this.player.update()
        this.boy.update()
